...
public static class AndroidBuilder
{
    public static void Build()
    {
        ...
        PlayerSettings.bundleVersion = CommandLineValue("-versionName") ?? "3.0.0";
        PlayerSettings.Android.bundleVersionCode = int.TryParse(CommandLineValue("-versionCode"), out var versionCode) ? versionCode : 4;
